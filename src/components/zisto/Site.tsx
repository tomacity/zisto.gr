  ...
  useEffect(() => {
    ...
    async function verifyAdmin() {
      try {
        ...
        if (active) {
          setIsAdmin(true);
          setAdminEmail(result.user?.email ?? session.user.email ?? "");
        }
      ...
      <div className="mx-auto max-w-7xl">
        <header className="flex flex-col gap-6 border-b border-black/10 pb-8 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-4 max-w-2xl text-sm leading-6 text-[#666] sm:text-base">
              Διαχείριση επιχειρήσεων, clients, invitations και smart links.
            </p>
          </div>
        ...
        <section className="mt-10 grid gap-5 sm:grid-cols-2 xl:grid-cols-4">
          ...
          >
            ...
            <p className="mt-3 text-sm leading-6 text-[#666]">
              Όλοι οι πελάτες και οι επιχειρήσεις στις οποίες έχουν πρόσβαση.
            </p>
          ...
          >
            ...
            <p className="mt-3 text-sm leading-6 text-[#666]">
              Έλεγχος ενεργών, ολοκληρωμένων και εκκρεμών invitations.
            </p>
          ...
          >
            ...
            <p className="mt-3 text-sm leading-6 text-white/70">
              Στείλε invitation email και σύνδεσε τον client με την επιχείρησή του.
            </p>
